...
export function MyProfile(props: propsType) {
  ...
  useEffect(() => {
    props.id
      ? dispatch(setProfileThunk(+props.id))
      : dispatch(setProfileThunk(meID));
  }, [props.id, meID]);

  const userProfile = useSelector<AppStateType, any>(
  ...
  return (
    <Grid container spacing={2}>
      <Grid item xs={12}>
        <Card
          elevation={2}
          style={{ borderRadius: "20px", backgroundColor: "#f3f2ef" }}
        >
          <CardHeader
            avatar={
              <Avatar
                ...
                aria-label="recipe"
                src={userProfile ? userProfile.photos?.large : ava}
              />
            }
          ...
          <CardContent>
            <Typography variant="body2" color="textSecondary" component="p">
              Имею опыт создания веб-приложений со стеком
              React-Redux-TypeScript. Открыт для ваших предложений.
            ...
            <Typography>
              <div style={{ display: "flex" }}>
                ...
                &nbsp;
                <span>
                  {userProfile.lookingForAJob ? <DoneIcon /> : <ClearIcon />}
                </span>
              </div>
            </Typography>
            <div style={{ display: "flex" }}>
          ...
          <List>
            ...
            <ListItem alignItems="flex-start">
              ...
              <ListItemText
                primary={
                  userProfile.contacts?.github ? (
                    <a href={"https://www.linkedin.com/in/victor-demin-react/"}>
                      www.linkedin.com
                    </a>
                  ) : (
                    "LinkedIn"
